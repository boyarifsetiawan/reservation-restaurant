    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="m-2 p-2 w-full">
        <div class="px-4 py-2 flex justify-center text-2xl w-full">
          <h1 class="text-slate-900 font-bold">Create Menu </h1>
        </div>
      </div>
      <div class="bg-slate-300 max-w-sm mx-auto p-8 rounded-lg shadow-lg">
        <form class="max-w-sm mx-auto" method="POST" action="{{ route('admin.menus.store') }} "
          ...
          <div class="max-w-sm mb-5">
            ...
            <select id="categories" name="categories[]" class="form-multiselect w-full max-w-xs" multiple>
